...
export const Banner = () => {
  return (
    <div className="md:h-96 p-10 flex flex-col gap-10 items-center justify-center bg-dark dark:bg-gray-100 rounded-tl-[100px] rounded-tr-xl rounded-bl-xl rounded-br-[100px]">
